...
config.General.requestName = 'HV19_RECO_ZB1' #can be anything
...
config.Data.outputDatasetTag = 'v3936_INC_SPL1_def_805p1_80X_dataRun2_Prompt_v6_HV19_0T_RECO'
config.Data.splitting = 'LumiBased'
config.Data.unitsPerJob = 2
#config.Data.totalUnits = 2
config.Data.runRange = '271195,271196,271197,271214,271304,271306,271307'
