...
# with command line options: MinBias_13TeV_cfi.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT:GRun --conditions auto:startup_GRun --pileup=NoPileUp -n 10
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('MinBias_13TeV_cfi_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
