...
sed -i "s;Ntuple.root;Ntuple_"$3".root;" test/TimingStudy_GenSimData_DynIneff_CMSSW7X_cfg.py
...
#sed -i "s;#minNStripHits = cms.int32(0),;minNStripHits = cms.int32(0),;" test/TimingStudy_GenSimData_DynIneff_CMSSW7X_cfg.py

# GlobalTag
sed -i "s;MC_70_V1;"$2";" test/TimingStudy_GenSimData_DynIneff_CMSSW7X_cfg.py

# Input file:
sed -i "s;file:/data/store/relval/CMSSW_7_1_0_pre1/GEN-SIM/A4846C0D-0B86-E311-8B2E-003048FEB9EE.root;"$4";" test/TimingStudy_GenSimData_DynIneff_CMSSW7X_cfg.py

# Pileup Input file:
sed -i "s;file:/data/store/relval/CMSSW_7_1_0_pre1/GEN-SIM/88CDC2A6-1186-E311-A9F5-02163E00E5C7.root;/store/caf/user/jkarancs/MinBias_TuneZ2star_8TeV_GENSIM_CMSSW_7_1_0pre1/MinBias_8TeV_GEN_SIM_2000k_1_1_FQV.root;" test/TimingStudy_GenSimData_DynIneff_CMSSW7X_cfg.py

# Set Number of Events if specified (all by default)
if ( $5 ) then
    sed -i "s;input = cms.untracked.int32(10);input = cms.untracked.int32("$5");" test/TimingStudy_GenSimData_DynIneff_CMSSW7X_cfg.py
else
    sed -i "s;input = cms.untracked.int32(10);input = cms.untracked.int32(-1);" test/TimingStudy_GenSimData_DynIneff_CMSSW7X_cfg.py
endif
...
echo "cmsRun test/TimingStudy_GenSimData_DynIneff_CMSSW7X_cfg.py"
echo "..."
echo
cmsRun test/TimingStudy_GenSimData_DynIneff_CMSSW7X_cfg.py
